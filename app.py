#use it to run the app: python -m streamlit run "d:/Siddharth col/fy project/image-caption-generator/image-caption-generator/app.py"
...
model = tf.keras.models.load_model(r"D:\Siddharth col\fy project\image-caption-generator\image-caption-generator\mymodel.h5")

# Load the tokenizer
with open(r"D:\Siddharth col\fy project\image-caption-generator\image-caption-generator\tokenizer.pkl", 'rb') as tokenizer_file:
